...
# get a list of emails to paste into outlook for forwarding event invite (last sent 2024-04-29): 
r102 |> 
  dplyr::filter(select_workshops___may == 1, date > lubridate::ymd_hms("2024-05-02 12:45:00")) |> 
  dplyr::pull(email) |> 
  unique() |> 
  paste0(collapse = "; ")
