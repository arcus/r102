...
One tricky little thing I want to be sure to draw your attention to is the equals test. In R, if you want to test whether two things are the same, you need to use `==`. 
Just a single `=` is used for setting values, not testing equality.
:::
