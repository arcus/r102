...
::: notes
One tricky little thing I want to be sure to draw your attention to is the equals test. 
:::
...
| `x > y`| greater than | `brainwt > 3` |
| `x == y` | equal to | `vore == "carni"` |
| `x <= y` | less than or equal to | `awake <= 12` |
| `x >= y` | greater than or equal to | `sleep_cycle >= 1` |
| `x != y` | not equal to | `conservation != "lc"` |
